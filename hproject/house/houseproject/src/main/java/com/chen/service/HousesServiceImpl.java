...
public class HousesServiceImpl extends ServiceImpl<HousesMapper, Houses> implements IHousesService {
    ...
    @Override
    public PageInfo<Houses> queryAll(Integer page, Integer pageSize, Houses houses) {

        PageHelper.startPage(page,pageSize);
        //查询所有的房屋信息
        List<Houses> list=housesMapper.queryAll(houses);
//        System.out.println(list);
    ...
    public PageInfo<Houses> findHouseAll2(Integer page, Integer pageSize, Integer id) {
        PageHelper.startPage(page,pageSize);
        //查询所有的房屋信息
        List<Houses> list=housesMapper.queryHouseAll2(id);
