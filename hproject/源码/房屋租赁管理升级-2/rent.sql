...
CREATE TABLE `contract` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='合同信息表';
...
INSERT INTO `contract` VALUES ('20', '1001', '8', '2020-12-21 16:00:00', null, '2020-12-30 16:00:00', '1200.00', null, null, null, null, '2001', '5');
...
CREATE TABLE `customer` (
  ...
  `xgr` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1009 DEFAULT CHARSET=utf8 COMMENT='租户信息表';

-- ----------------------------
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1001', '123456', '123456', 'lilys', '女', '北京', '15612345678', '程序员', '无', null, null, null, null);
INSERT INTO `customer` VALUES ('1002', '4212334757676', '1', 'lily', '男', '233334343', '13134566777', 'ui', '1111111111', null, null, null, null);
...
-- ----------------------------
INSERT INTO `lookhouse` VALUES ('2001', '8', '1001', '2020-10-07 14:57:31', '看房', null, null, null, null, '1');
...
CREATE TABLE `notice` (
  ...
  `xgr` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='公告信息表 公布最新优质房源';
...
INSERT INTO `notice` VALUES ('8', 'wqewqewewqewqewq', '2020-11-17 04:48:43', null, null, null);
INSERT INTO `notice` VALUES ('9', '122222222', '2020-11-17 04:49:33', null, null, null);
INSERT INTO `notice` VALUES ('10', '222', '2020-11-17 04:59:34', null, null, null);
INSERT INTO `notice` VALUES ('11', 'asdfsadf', '2020-11-17 05:00:24', null, null, null);
INSERT INTO `notice` VALUES ('12', '2222', '2020-11-17 05:01:04', null, null, null);
...
CREATE TABLE `rentals` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10013 DEFAULT CHARSET=utf8 COMMENT='收租信息表';
...
INSERT INTO `rentals` VALUES ('10011', '8', '1006', '1500', null, '2020-11-30 16:00:00', '12', '', '2020-12-18 07:58:13', null, null, null, '2020-10-31 16:00:00');
INSERT INTO `rentals` VALUES ('10012', '8', '1002', '1200', null, '2020-12-13 16:00:00', '2', '2221', '2020-12-18 09:14:29', null, null, null, '2020-10-31 16:00:00');
...
CREATE TABLE `rentinfo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2012 DEFAULT CHARSET=utf8 COMMENT='租赁信息表';
...
INSERT INTO `rentinfo` VALUES ('2011', '8', '1001', '20', null, null, '2020-12-17 03:56:48', null, null, null, null);
INSERT INTO `rentinfo` VALUES ('2010', '12', '1001', '19', null, null, '2020-10-19 09:17:19', null, null, null, '1');
