...
CREATE TABLE `contract` (
  ...
  `kfrq` datetime DEFAULT NULL COMMENT '0 代表女\r\n            1 代表男',
  ...
  `rent_id` char(10) DEFAULT NULL COMMENT '租赁用户的身份证号',
  `payrent` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Records of contract
-- ----------------------------
INSERT INTO `contract` VALUES ('10', '1001', '8', '2020-09-30 16:00:00', null, '2020-10-30 16:00:00', '100.00', '300', null, null, null, null, '2001', '12');
INSERT INTO `contract` VALUES ('16', '1001', '12', '2020-10-31 16:00:00', null, '2020-10-30 16:00:00', '100.00', '370', null, null, null, null, '2006', '1');
INSERT INTO `contract` VALUES ('15', '1001', '12', '2020-10-31 16:00:00', null, '2020-10-30 16:00:00', '100.00', '370', null, null, null, null, '2006', '1');
INSERT INTO `contract` VALUES ('17', '1001', '12', '2020-09-30 16:00:00', null, '2020-10-30 16:00:00', '100.00', '300', null, null, null, null, '2006', '1');
INSERT INTO `contract` VALUES ('18', '1001', '12', '2020-09-30 16:00:00', null, '2020-10-30 16:00:00', '110.00', '300', null, null, null, null, '2006', '2');
INSERT INTO `contract` VALUES ('19', '1001', '12', '2020-08-30 16:00:00', null, '2020-10-15 16:00:00', '230.00', '500', null, null, null, null, '2006', '5');
...
CREATE TABLE `houses` (
  ...
  `sort` double(5,2) DEFAULT NULL COMMENT '0 代表女\r\n            1 代表男',
...
CREATE TABLE `notice` (
  ...
  `xgr` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='公告信息表 公布最新优质房源';
...
CREATE TABLE `owner` (
  ...
  `djr` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='房东信息表';
